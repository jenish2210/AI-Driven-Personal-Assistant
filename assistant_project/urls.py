...
from django.contrib import admin
from django.urls import path, include # Replace with the correct function name
...
router.register(r'contacts', views.EmergencyContactViewSet, basename='emergencycontact')
